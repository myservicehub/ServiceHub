...
import { Shield, Calendar, Clock, ChevronRight, FileText, Users, Lock } from 'lucide-react';
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-500">
                    Please see our{' '}
                    <Link to="/cookie-policy" className="text-[#34D164] hover:underline">Cookie Policy</Link>
                    {' '}and{' '}
                    <Link to="/contact" className="text-[#34D164] hover:underline">Contact page</Link>.
                  </p>
                </div>
              ) : (
