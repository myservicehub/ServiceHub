...
import { parseServerDate, formatMessageTime } from '../../../utils/datetime';
  ...
  return (
    <div className="h-[calc(100vh-120px)] flex flex-col">
      ...
      <HiringStatusModal
        ...
        onClose={() => {
          setShowHiringStatusModal(false);
          loadConversations(true);
        }}
        ...
        onComplete={({ jobStatus }) => {
          if (jobStatus && selectedConversation) {
            setSelectedConversation((prev) =>
              prev ? { ...prev, job_status: jobStatus } : prev
            );
          }
          loadConversations(true);
        }}
