...
export const ContactShared = ({
  ...
  paymentUrl = 'https://myservicehub.co/pay/123',
}: ContactSharedProps) => (
  <Html>
    <Head>
    ...
    <Preview>The homeowner has shared their contact details for {jobTitle}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          <Heading style={h1}>Contact Details Shared!</Heading>
          
          <Text style={greeting}>Hello {tradespersonName},</Text>
          
          <Text style={paragraph}>
            Excellent news! The homeowner has shared their contact details for the 
            job you showed interest in.
          </Text>
          ...
          <Text style={paragraph}>
            To access the homeowner's contact details and start the project, 
            please pay the access fee.
          </Text>
          ...
          <Text style={noteText}>
            This is your opportunity to connect directly with the homeowner 
            and discuss the job details.
          </Text>
...
const noteText = { color: '#6b7280', fontSize: '14px', textAlign: 'center' as const, margin: '0 0 24px' };
