...
export const JobApproved = ({
  homeownerName = 'John',
  jobId = 'JOB-2025-001',
  jobTitle = 'Kitchen Renovation',
  approvedAt = 'March 12, 2025 at 2:30 PM',
  adminNotes = '',
}: JobApprovedProps) => (
  <Html>
    <Head>
    ...
    <Preview>Great news! Your job "{jobTitle}" is now live on ServiceHub</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
              ...
              <td align="center" style={{ textAlign: 'center' }}>
                <table cellPadding="0" cellSpacing="0" style={{ margin: '0 auto' }}>
                  <tr>
                    ...
                    <td style={{ verticalAlign: 'middle' }}>
                      <Text style={{ ...h1, margin: '0', lineHeight: '1' }}>Your Job is Live!</Text>
                    </td>
                  </tr>
                </table>
              </td>
          ...
          <Text style={paragraph}>
            Your job posting has been approved and is now visible to qualified 
            tradespeople on ServiceHub.
          </Text>
          ...
          <table cellPadding="0" cellSpacing="0" style={detailsCard}>
            ...
            <tr>
              <td style={detailRow}>
                ...
                <Text style={detailValueGreen}>Approved</Text>
              </td>
            </tr>
            <tr>
              <td style={{ ...detailRow, borderBottom: 'none' }}>
                <Text style={detailLabel}>Approved On</Text>
                <Text style={detailValue}>{approvedAt}</Text>
              </td>
            </tr>
          </table>
          
          {adminNotes && (
            <table cellPadding="0" cellSpacing="0" style={adminNoteBox}>
              <tr>
                <td style={adminNoteInner}>
                  <Text style={adminNoteLabel}>Note from Admin:</Text>
                  <Text style={adminNoteText}>{adminNotes}</Text>
                </td>
              </tr>
            </table>
          )}
          ...
          <Text style={paragraph}>
            Tradespeople in your area will be notified and can start showing 
            interest immediately. You'll receive notifications as soon as they apply.
          </Text>
...
const detailValueGreen = { color: '#16a34a', fontSize: '15px', fontWeight: '600', margin: '0' };
const adminNoteBox = { width: '100%', marginBottom: '24px' };
const adminNoteInner = { backgroundColor: '#fffbeb', border: '1px solid #fef3c7', borderRadius: '8px', padding: '12px 16px' };
const adminNoteLabel = { color: '#92400e', fontSize: '13px', fontWeight: '600', margin: '0 0 8px' };
const adminNoteText = { color: '#92400e', fontSize: '14px', margin: '0', lineHeight: '1.5' };
