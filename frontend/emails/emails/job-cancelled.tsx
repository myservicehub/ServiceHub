...
export const JobCancelled = ({
  ...
  cancellationDate = 'March 12, 2025',
  cancellationReason = 'Project postponed indefinitely',
  browseJobsUrl = 'https://myservicehub.co/jobs',
}: JobCancelledProps) => (
  <Html>
    <Head>
    ...
    <Preview>Job cancelled: {jobTitle}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
                ...
                <table cellPadding="0" cellSpacing="0" style={{ margin: '0 auto' }}>
                  <tr>
                    <td style={{ verticalAlign: 'middle', paddingRight: '12px', lineHeight: '0' }}>
                      <Img src="https://cdn-icons-png.flaticon.com/512/1828/1828843.png" width="32" height="32" alt="" style={{ display: 'block' }} />
                    </td>
                    <td style={{ verticalAlign: 'middle' }}>
                      <Text style={{ ...h1, margin: '0', lineHeight: '1' }}>Job Cancelled</Text>
                    </td>
                  </tr>
                </table>
              </td>
          ...
          <table cellPadding="0" cellSpacing="0" style={detailsCard}>
            ...
            <tr>
              <td style={detailRow}>
                <Text style={detailLabel}>Homeowner</Text>
            ...
            <tr>
              <td style={detailRow}>
                ...
                <Text style={detailValueRed}>Cancelled</Text>
              </td>
            </tr>
            <tr>
              <td style={{ ...detailRow, borderBottom: 'none' }}>
                <Text style={detailLabel}>Cancelled</Text>
          ...
          <Text style={paragraph}>
            We understand this is disappointing. The homeowner has decided to cancel 
            this project at this time.
          </Text>
          
          <Text style={encourageText}>
            Don't worry - there are many other opportunities available! Keep browsing 
            for new jobs that match your skills.
          </Text>
          
          <Section style={buttonContainer}>
            <Button style={primaryButton} href={browseJobsUrl}>
              🔍 Browse New Jobs
            </Button>
          </Section>
          ...
          <Text style={securityNote}>
            You're receiving this because you showed interest in a job on ServiceHub.
          </Text>
        </Section>
...
const heroTable = { width: '100%', height: '200px', backgroundImage: 'url(https://my-servicehub.vercel.app/stock/bg8.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' };
...
const detailValueRed = { color: '#dc2626', fontSize: '15px', fontWeight: '600', margin: '0' };
const reasonBox = { width: '100%', marginBottom: '24px' };
const reasonBoxInner = { backgroundColor: '#fef2f2', border: '1px solid #fecaca', borderRadius: '8px', padding: '12px 16px' };
const reasonLabel = { color: '#dc2626', fontSize: '13px', fontWeight: '600', margin: '0 0 4px' };
const reasonText = { color: '#b91c1c', fontSize: '14px', margin: '0' };
const encourageText = { color: '#16a34a', fontSize: '15px', fontWeight: '500', textAlign: 'center' as const, margin: '0 0 24px', lineHeight: '1.5' };
