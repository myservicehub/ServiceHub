...
export const JobCompleted = ({
  ...
  completionDate = 'March 12, 2025',
  interestsUrl = 'https://myservicehub.co/interests',
}: JobCompletedProps) => (
  <Html>
    <Head>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
              ...
              <td align="center" style={{ textAlign: 'center' }}>
                <table cellPadding="0" cellSpacing="0" style={{ margin: '0 auto' }}>
                  <tr>
                    ...
                    <td style={{ verticalAlign: 'middle' }}>
                      <Text style={{ ...h1, margin: '0', lineHeight: '1' }}>Job Completed!</Text>
                    </td>
                  </tr>
                </table>
              </td>
          ...
          <table cellPadding="0" cellSpacing="0" style={detailsCard}>
            ...
            <tr>
              <td style={detailRow}>
                ...
                <Text style={detailValueGreen}>Completed</Text>
              </td>
            </tr>
            <tr>
          ...
          <Text style={paragraph}>
            The homeowner has indicated that the work for this project has been finished. 
            If you were selected for this job and have completed the work, congratulations 
            on a successful project!
          </Text>
          
          <Section style={buttonContainer}>
            <Button style={primaryButton} href={interestsUrl}>
              View Your Interests
            </Button>
          </Section>
...
const heroTable = { width: '100%', height: '200px', backgroundImage: 'url(https://my-servicehub.vercel.app/stock/bg3.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' };
