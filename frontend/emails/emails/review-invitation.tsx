...
export const ReviewInvitation = ({
  ...
  reviewUrl = 'https://myservicehub.co/review/123',
  ...
  <Html>
    ...
    <Preview>Share your experience - Review {tradespersonName}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
              ...
              <td align="center" style={{ textAlign: 'center' }}>
                <table cellPadding="0" cellSpacing="0" style={{ margin: '0 auto' }}>
                  <tr>
                    ...
                    <td style={{ verticalAlign: 'middle' }}>
                      <Text style={{ ...h1, margin: '0', lineHeight: '1' }}>Share Your Experience</Text>
                    </td>
                  </tr>
                </table>
              </td>
          ...
          <Text style={paragraph}>
            Your job has been completed! We hope you're satisfied with the work 
            done by <strong>{tradespersonName}</strong>.
          </Text>
          ...
          <table cellPadding="0" cellSpacing="0" style={detailsCard}>
            ...
            <tr>
              <td style={detailRow}>
                <Text style={detailLabel}>Tradesperson</Text>
                <Text style={detailValue}>{tradespersonName}</Text>
              </td>
            </tr>
            <tr>
              <td style={{ ...detailRow, borderBottom: 'none' }}>
                <Text style={detailLabel}>Completed</Text>
                <Text style={detailValue}>{completionDate}</Text>
              </td>
            </tr>
          </table>
          ...
          <Text style={listItem}>• Rate the quality of work (1-5 stars)</Text>
          <Text style={listItem}>• Comment on professionalism and timeliness</Text>
          <Text style={listItem}>• Upload photos of the completed work</Text>
          ...
          <Text style={noteText}>
            Your honest feedback helps build a trusted community and helps 
            {tradespersonName} grow their business.
          </Text>
          
          <Hr style={divider} />
          
          <Text style={securityNote}>
            This invitation expires in 30 days. If you have any issues with the 
            completed work, please contact us immediately.
          </Text>
        </Section>
...
const heroTable = { width: '100%', height: '200px', backgroundImage: 'url(https://my-servicehub.vercel.app/stock/bg10.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' };
...
const noteText = { color: '#6b7280', fontSize: '14px', textAlign: 'center' as const, margin: '0 0 24px', lineHeight: '1.5' };
const divider = { borderColor: '#e5e7eb', margin: '24px 0' };
const securityNote = { color: '#9ca3af', fontSize: '13px', textAlign: 'center' as const, margin: '0', lineHeight: '1.5' };
