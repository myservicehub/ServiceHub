...
export const NewReviewReceived = ({
  revieweeName = 'Michael',
  reviewerName = 'John Doe',
  jobId = 'JOB-2025-001',
  jobTitle = 'Kitchen Renovation',
  rating = 5,
  reviewUrl = 'https://myservicehub.co/reviews/123',
  ...
  return (
    <Html>
      ...
      <Preview>You received a {rating.toString()}-star review from {reviewerName}!</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
                  ...
                  <table cellPadding="0" cellSpacing="0" style={{ margin: '0 auto' }}>
                    <tr>
                      <td style={{ verticalAlign: 'middle', paddingRight: '12px', lineHeight: '0' }}>
                        <Img src="https://cdn-icons-png.flaticon.com/512/1828/1828884.png" width="32" height="32" alt="" style={{ display: 'block' }} />
                      </td>
                      <td style={{ verticalAlign: 'middle' }}>
                        <Text style={{ ...h1, margin: '0', lineHeight: '1' }}>New Review Received!</Text>
                      </td>
                    </tr>
                  </table>
                </td>
            ...
            <Text style={greeting}>Hello {revieweeName},</Text>
            
            <Text style={paragraph}>
              Congratulations! You've received a new review on ServiceHub.
            </Text>
            
            <table cellPadding="0" cellSpacing="0" style={reviewCard}>
              <tr>
                <td style={reviewCardInner}>
                  <Text style={starsText}>{stars}</Text>
                  <Text style={ratingText}>{rating}/5 Stars</Text>
                  <Hr style={reviewDivider} />
                  <Text style={reviewerText}>From: {reviewerName}</Text>
                  <Text style={jobText}>Job #{jobId}: {jobTitle}</Text>
                </td>
              </tr>
            </table>
            
            <Text style={paragraph}>
              Your reputation is growing! Reviews help you win more jobs by building 
            ...
            <Text style={securityNote}>
              You're receiving this because you completed a job on ServiceHub.
            </Text>
          </Section>
...
export default NewReviewReceived;
...
const heroTable = { width: '100%', height: '200px', backgroundImage: 'url(https://my-servicehub.vercel.app/stock/bg9.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' };
...
const reviewCard = { width: '100%', marginBottom: '24px' };
const reviewCardInner = { backgroundColor: '#fef3c7', border: '2px solid #fcd34d', borderRadius: '12px', padding: '24px', textAlign: 'center' as const };
const starsText = { fontSize: '32px', margin: '0 0 8px' };
const ratingText = { color: '#92400e', fontSize: '18px', fontWeight: '700', margin: '0' };
const reviewDivider = { borderColor: '#fcd34d', margin: '16px 0' };
const reviewerText = { color: '#78350f', fontSize: '14px', margin: '0 0 4px' };
const jobText = { color: '#78350f', fontSize: '14px', margin: '0' };
