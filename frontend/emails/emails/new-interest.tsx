...
interface NewInterestProps {
  homeownerName?: string;
  jobId?: string;
  jobTitle?: string;
  jobLocation?: string;
  tradespersonName?: string;
  tradespersonExperience?: string;
  viewUrl?: string;
}
...
export const NewInterest = ({
  ...
  tradespersonExperience = '5',
  viewUrl = 'https://myservicehub.co/jobs/123/interests',
}: NewInterestProps) => (
  <Html>
    <Head>
    ...
    <Preview>A tradesperson is interested in your {jobTitle} job</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          <Heading style={h1}>New Interest in Your Job</Heading>
          
          <Text style={greeting}>Hello {homeownerName},</Text>
          
          <Text style={paragraph}>
            Great news! A tradesperson has shown interest in your job posting. 
          ...
          <table cellPadding="0" cellSpacing="0" style={detailsCard}>
            ...
            <tr>
              <td style={{ ...detailRow, borderBottom: 'none' }}>
                ...
                <Text style={detailValue}>{tradespersonExperience} years</Text>
              </td>
            </tr>
          </table>
          
          <Text style={paragraph}>
            Review their profile and decide if you'd like to share your contact details.
          </Text>
          
          <Section style={buttonContainer}>
            <Button style={primaryButton} href={viewUrl}>
              View Interested Tradespeople
            </Button>
          </Section>
...
const heroTable = {
  width: '100%',
  height: '200px',
  backgroundImage: 'url(https://my-servicehub.vercel.app/stock/bg12.jpg)',
