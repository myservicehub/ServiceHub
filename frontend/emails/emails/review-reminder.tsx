...
export const ReviewReminder = ({
  ...
  <Html>
    ...
    <Preview>Don't forget - Review {tradespersonName} (expires in {daysRemaining} days)</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
              ...
              <td align="center" style={{ textAlign: 'center' }}>
                <table cellPadding="0" cellSpacing="0" style={{ margin: '0 auto' }}>
                  <tr>
                    ...
                    <td style={{ verticalAlign: 'middle' }}>
                      <Text style={{ ...h1, margin: '0', lineHeight: '1' }}>Reminder: Leave Your Review</Text>
                    </td>
                  </tr>
                </table>
              </td>
          ...
          <Text style={paragraph}>
            We noticed you haven't left a review for your recently completed job yet. 
          ...
          <Text style={listItem}>✅ Other homeowners make informed decisions</Text>
          <Text style={listItem}>✅ Tradespeople improve their services</Text>
          <Text style={listItem}>✅ Build a trusted community on ServiceHub</Text>
          ...
          <table cellPadding="0" cellSpacing="0" style={warningBox}>
            <tr>
              <td style={warningBoxInner}>
                <Text style={warningText}>⏳ This invitation expires in {daysRemaining} days</Text>
              </td>
            </tr>
          </table>
...
const heroTable = { width: '100%', height: '200px', backgroundImage: 'url(https://my-servicehub.vercel.app/stock/bg12.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' };
...
const highlightText = { color: '#0a1b3d', fontSize: '15px', fontWeight: '600', textAlign: 'center' as const, margin: '0 0 24px' };
...
const warningBox = { width: '100%', marginBottom: '24px' };
const warningBoxInner = { backgroundColor: '#fef3c7', borderRadius: '8px', padding: '12px 16px', textAlign: 'center' as const };
const warningText = { color: '#92400e', fontSize: '14px', fontWeight: '600', margin: '0' };
